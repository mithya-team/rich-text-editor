...
const UploadZone = ({ onDefault, onUploading, onFinish, uploadTo, }) => {
    ...
    const onDrop = React.useCallback((acceptedFiles) => __awaiter(void 0, void 0, void 0, function* () {
        setUploading(true);
    ...
    if (!uploading)
        return (React__default["default"].createElement("div", Object.assign({}, getRootProps({ className: "dropzone" }), { className: "dropzone" }),
...
const onDefault = () => {
    return React__default["default"].createElement("p", null, "Drag 'n' drop some files here, or click to select files");
};
const onUploading = () => {
...
class Embed extends BlockEmbed {
    static create([embedObject, EmbedPlaceholder]) {
...
var css_248z = ".editor-main {\r\n  display: grid;\r\n  place-items: center;\r\n}\r\n.ql-addImage {\r\n  background-image: url(\"./add-image.svg\") !important;\r\n  background-repeat: no-repeat !important;\r\n}\r\n.add-embed {\r\n  border-color: black;\r\n  border-radius: 4px;\r\n}\r\n.ql-customembed:before {\r\n  content: \"+ Add embed\";\r\n  width: 10em;\r\n}\r\n.ql-customembed {\r\n  color: #444 !important;\r\n  font-size: 14px !important;\r\n  font-weight: 500 !important;\r\n  border: 1px solid transparent !important;\r\n  width: 7em !important;\r\n  font-family: Arial, Helvetica, sans-serif !important;\r\n}\r\n";
styleInject(css_248z);

const Editor = ({ quillProps = null, imageUploader = null, ImageUploadHandler = null, AddEmbedHandler = null, EmbedPlaceholder = null, options = null, customTag = "default", className = "editor-main", onChange, }) => {
    var _a;
    if (AddEmbedHandler) {
    ...
    const [showEmbedHandler, setEmbedHandler] = React.useState(false);
    ...
    const quillObj = React.useRef(null);
    ...
    const ImageModalBox = React.useMemo(() => {
        if (showImageHandler) {
            if (ImageUploadHandler)
                return React__default["default"].createElement(ImageUploadHandler, { onFinish: insertImage });
            else if (imageUploader)
                return React__default["default"].createElement(Modal, { imageUploader: imageUploader, onFinish: insertImage });
        }
        else
            return "";
    ...
    return (React__default["default"].createElement("div", { className: className },
        React__default["default"].createElement("div", null,
            ...
            ImageModalBox,
            AddEmbedHandler && showEmbedHandler && (React__default["default"].createElement(AddEmbedHandler, { onFinish: addEmbed })))));
};

/**
 * Separates out html strings and json object containing props for renderer.
 */
function chunkOutRenderString(renderString, customTag) {
    let chunks = [];
    ...
    while (_renderString.length) {
        ...
        if (openingTagStartIndex !== -1) {
            ...
            if (elem instanceof HTMLElement) {
                ...
                if (jsonChunk)
                    chunks.push(JSON.parse(jsonChunk));
            }
