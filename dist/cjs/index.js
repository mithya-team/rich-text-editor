...
const Editor = ({ quillProps = null, imageUploader = null, ImageUploadHandler = null, AddEmbedHandler = null, options = null, customTag = "default", className = "editor-main", onChange, }) => {
    var _a;
    if (AddEmbedHandler) {
