...
const Modal = (props) => {
    ...
    return (React__default["default"].createElement("div", { className: "backdrop" },
        React__default["default"].createElement("div", { className: "foreground" },
            React__default["default"].createElement("div", Object.assign({}, getRootProps({ className: "dropzone" }), { className: "dropzone" }),
                React__default["default"].createElement("input", Object.assign({}, getInputProps())),
                React__default["default"].createElement("p", null, "Drag 'n' drop some files here, or click to select files"))),
        uploading && React__default["default"].createElement("div", { className: "uploading" }, "Uploading...")));
};
...
const Editor = (props) => {
    ...
    return (React__default["default"].createElement("div", { className: "main" },
        React__default["default"].createElement("div", null,
            ...
            showModal && (React__default["default"].createElement(Modal, { closeModal: closeModal, imageUploader: props.imageUploader, insertImage: insertImage })))));
};
