...
const UploadZone = ({ onDefault, onUploading, onFinish, uploadTo, }) => {
    const [uploading, setUploading] = React$2.useState(false);
    const onDrop = React$2.useCallback((acceptedFiles) => __awaiter(void 0, void 0, void 0, function* () {
        setUploading(true);
...
const Editor = ({ quillProps, imageUploader, options, onChange, }) => {
    const [showModal, setShowModal] = React$2.useState(false);
...
const Display = ({ delta }) => {
    ...
    return React__default["default"].createElement("div", { className: "cover" }, parse(html));
};
