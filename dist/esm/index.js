...
const Modal = (props) => {
    ...
    return (React.createElement("div", { className: "backdrop" },
        React.createElement("div", { className: "foreground" },
            React.createElement("div", Object.assign({}, getRootProps({ className: "dropzone" }), { className: "dropzone" }),
                React.createElement("input", Object.assign({}, getInputProps())),
                React.createElement("p", null, "Drag 'n' drop some files here, or click to select files"))),
        uploading && React.createElement("div", { className: "uploading" }, "Uploading...")));
};
...
const Editor = (props) => {
    ...
    return (React.createElement("div", { className: "main" },
        React.createElement("div", null,
            ...
            showModal && (React.createElement(Modal, { closeModal: closeModal, imageUploader: props.imageUploader, insertImage: insertImage })))));
};
