import React, { forwardRef, useImperativeHandle, Fragment, useMemo, useRef, useReducer, useEffect, useCallback, useState } from 'react';
...
const UploadZone = ({ onDefault, onUploading, onFinish, uploadTo, }) => {
    ...
    if (!uploading)
        return (React.createElement("div", Object.assign({}, getRootProps({ className: "dropzone" }), { className: "dropzone" }),
...
const onDefault = () => {
    return React.createElement("p", null, "Drag 'n' drop some files here, or click to select files");
};
const onUploading = () => {
    ...
    const ImageModalBox = useMemo(() => {
        if (showImageHandler) {
            if (ImageUploadHandler)
                return React.createElement(ImageUploadHandler, { onFinish: insertImage });
            else if (imageUploader)
                return React.createElement(Modal, { imageUploader: imageUploader, onFinish: insertImage });
        }
        else
            return "";
...
export { Editor, Renderer, ToolbarOptions, buildContainer };
